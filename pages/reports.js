...
export default function Reports() {
  ...
  // Dados para relatórios - agora usando dados reais
  const totalAnimais = 0; // Será carregado da API
  const animaisPorRaca = {}; // Será carregado da API
  const animaisPorIdade = {
    "Bezerro (0-3 meses)": 0,
    "Bezerro maior (4-8 meses)": 0,
    "Desmama (9-12 meses)": 0,
    "Garrote (12-24 meses)": 0,
    "Garrote Senior (25-36 meses)": 0,
    "Adulto (36+ meses)": 0,
  };
  const custoPorTipo = {}; // Será carregado da API
